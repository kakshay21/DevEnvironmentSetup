...
require'nvim-treesitter.configs'.setup { ensure_installed = { "go", "rust", "java" }, highlight = { enable = true } }
...
lsp_installer.settings({
	ensure_installed = {"gopls"}, -- ensure these servers are always installed
